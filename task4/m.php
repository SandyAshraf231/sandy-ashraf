...
<tr>
                       ...
                       <td><input  type="text" class="form-control " name="product_name<?= $i ?>" id="product_name<?= $i ?>"></td>
                       <td><input  type="text" class="form-control " name="price<?= $i ?>" id="price<?= $i ?>"></td>
                       <td><input  type="text" class="form-control " name="Quantity<?= $i ?>" id="Quantity<?= $i ?>"></td>
...
?>
        ...
        <td> <?= $sub_total = $_POST["price{$i}"] * $_POST["Quantity{$i}"] ;
?> </td>
...
elseif( $total > 4500)
{
    ...
    <tr>
        <th>net total</th>
        <td><?=
         $net_total =   $total_after_discound + 
            $net_total ?? ""?></td>
